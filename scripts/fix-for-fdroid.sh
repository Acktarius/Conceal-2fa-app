...
grep -q ':expo-document-picker' android/settings.gradle || echo -e 'include(":expo-document-picker")\nproject(":expo-document-picker").projectDir = new File(rootProject.projectDir, "../node_modules/expo-document-picker/android")' >> android/settings.gradle
...
sed -i 's/host\.exp\.exponent:expo\.modules\.documentpicker:[0-9.]\+/project(":expo-document-picker")/g' node_modules/expo/android/build.gradle
