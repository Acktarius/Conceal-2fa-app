...
export class CryptoService {
  ...
  static async hmacSha256(key: Uint8Array, data: Uint8Array): Promise<Uint8Array> {
    ...
    for (let i = 0; i < blockSize; i++) {
      inner[i] = keyBytes[i] ^ 0x36;
      outer[i] = keyBytes[i] ^ 0x5c;
    }
    const innerData = new Uint8Array(blockSize + data.length);
    innerData.set(inner);
    innerData.set(data, blockSize);
  ...
  static async hmacSha512(key: Uint8Array, data: Uint8Array): Promise<Uint8Array> {
    ...
    const KL = new Uint32Array([
      0xd728ae22, 0x23ef65cd, 0xec4d3b2f, 0x8189dbbc, 0xf348b538, 0xb605d019, 0xaf194f9b, 0xda6d8118, 0xa3030242, 0x45706fbe, 0x4ee4b28c,
      0xd5ffb4e2, 0xf27b896f, 0x3b1696b1, 0x25c71235, 0xcf692694, 0x9ef14ad2, 0x384f25e3, 0x8b8cd5b5, 0x77ac9c65, 0x592b0275, 0x6ea6e483,
      0xbd41fbd4, 0x831153b5, 0xee66dfab, 0x2db43210, 0x98fb213f, 0xbeef0ee4, 0x3da88fc2, 0x930aa725, 0xe003826f, 0x0a0e6e70, 0x46d22ffc,
      0x5c26c926, 0x5ac42aed, 0x9d95b3df, 0x8baf63de, 0x3c77b2a8, 0x47edaee6, 0x1482353b, 0x4cf10364, 0xbc423001, 0xd0f89791, 0x0654be30,
      0xd6ef5218, 0x5565a910, 0x5771202a, 0x32bbd1b8, 0xb8d2d0c8, 0x5141ab53, 0xdf8eeb99, 0xe19b48a8, 0xc5c95a63, 0xe3418acb, 0x7763e373,
      0xd6b2b8a3, 0x5defb2fc, 0x43172f60, 0xa1f0ab72, 0x1a6439ec, 0x23631e28, 0xde82bde9, 0xb2c67915, 0xe372532b,
    ]);
